...
def batch_iter(data, batch_size, slang, tlang, shuffle=False, mapping=False):
            ...
            for e in examples:
                ...
                while sl>0:
                    ...
                    #    s = s[1:]              
                        ...
                        noise_l = 16 if mapping else 8    # mapping(번역하는 경우) 노이즈가 작게 (숫자 크게)
                ...
                for i in range(sl):
                    ...
                    if w in sbol:
                        ...
                        sent.append(wk)
                    elif not mapping and np.random.randint(5) < 1:  #mapping 할 경우 <unk> noise 를 추가하지 않음 
